package com.letter.socketassistant.esptouch;
...
public class EsptouchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.esp_title);
        }

        mApSsidTV = findViewById(R.id.esp_ssid);
        mApBssidTV = findViewById(R.id.esp_bssid);
        mApPasswordET = findViewById(R.id.esp_password);
        mDeviceCountET = findViewById(R.id.esp_device_count);
        mDeviceCountET.setText("1");
        mPackageModeGroup = findViewById(R.id.esp_mode);
        mMessageTV = findViewById(R.id.esp_message);
        mConfirmBtn = findViewById(R.id.esp_confirm);
        mConfirmBtn.setEnabled(false);
        mConfirmBtn.setOnClickListener(this);

        TextView versionTV = findViewById(R.id.esp_version);
        versionTV.setText(getString(R.string.esp_version, IEsptouchTask.ESPTOUCH_VERSION));
        ...
        if (!connected) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (frequence > 4900 && frequence < 5900) {
                    ...
                    mMessageTV.setText(R.string.esp_5g_not_support);
                }
            }
        }
    }
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            ...
            byte[] broadcast = {(byte) (mPackageModeGroup.getCheckedRadioButtonId() == R.id.esp_broadcast
                    ? 1 : 0)};
